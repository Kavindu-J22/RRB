...
/// RRB Results Screen — displays detection results returned by the ML service
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Back button — recording screen used pushReplacement, so one pop
            // returns to RRB Home
            ElevatedButton.icon(
...
class _BehaviorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = Color(
      RrbConfig.categoryColors[behavior.behavior] ?? 0xFF2196F3,
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Occurrences: ${behavior.occurrences}'),
                Text('Duration: ${behavior.totalDuration.toStringAsFixed(1)}s'),
              ],
            ),
          ],
        ),
